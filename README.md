...
[![ggspc HTML
Manual](http://img.shields.io/badge/docs-HTML-informational)](https://humus.rocks/ggspc/)
[![CRAN
status](https://www.r-pkg.org/badges/version/ggspc)](https://CRAN.R-project.org/package=ggspc)
[![Codecov test
coverage](https://codecov.io/gh/brownag/ggspc/branch/main/graph/badge.svg)](https://app.codecov.io/gh/brownag/ggspc?branch=main)
<!-- badges: end -->
